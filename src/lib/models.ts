  ...
  loan: {
    ...
    fields: [
      ...
      { name: 'escrowIncluded', label: 'Escrow included', type: 'checkbox', span: 3 },
      {
        ...
        span: 3,
        placeholder: '250.00',
        help: 'The escrow portion of each payment, on top of principal and interest.',
      },
      {
        name: 'escrowTaxAnnualCents',
        label: 'Property tax paid from escrow (per year)',
        type: 'money',
        span: 3,
        placeholder: '2,400.00',
        help: 'What the servicer disburses, not what you pay in. Off the year-end escrow analysis. Leave blank if you do not know it yet — the report will say so rather than guess.',
      },
      {
        name: 'escrowInsuranceAnnualCents',
        label: 'Insurance paid from escrow (per year)',
        type: 'money',
        span: 3,
        placeholder: '1,800.00',
        help: 'Same source. These two are what reach the Schedule E taxes and insurance lines; escrow paid in reaches neither.',
      },
      {
  ...
  payeeRule: {
    ...
    fields: [
      ...
      },
      {
        ...
        defaultValue: 'any',
        help: 'The same description can mean two different things depending on which way the money moved. A transfer out is an owner draw; the same transfer in is a contribution.',
      },
      {
        name: 'priority',
        label: 'Priority',
